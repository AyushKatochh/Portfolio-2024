...
},
{
  ...
  id:52,
  children:<SiOpenai  className="text-3xl  font-normal text-green-500"></SiOpenai>,
  name:"OpenAi"
},]
...
export  const Database:Generictype[]=[{
  ...
  {
    id:27,
    children:<SiElasticsearch className="text-3xl font-normal text-yellow-600"></SiElasticsearch>,
    name:"Elasticsearch"
  }
]
