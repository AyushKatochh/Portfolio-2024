...
import ayushImage from "./ayush-modified.png";
  ...
  return (
    ...
    >
      ...
      <div className="absolute text-center  ">
        ...
        <Image src={ayushImage} alt="Background Image" width={300} height={300} className="h-full w-10/12 rounded-full ml-4" />
        ...
        <div className="flex justify-center gap-8 mt-8">
          ...
          >
            <a href="/ayush_resume.pdf" download={true} className="text-md font-medium bg-gradient-to-r from-white  to-slate-500 text-transparent bg-clip-text">
              Download Resume{" "}
            </a>
        ...
        <motion.div  className="flex justify-around  md:hidden   items-center mt-12 text-xl">
          <a href={"https://github.com/AyushKatochh"} target="_blank">
          ...
          <a
            href={"https://www.linkedin.com/in/ayush-katoch-00197021a/"}
            target="_blank"
          >
            <motion.div initial={{opacity:0, y:100}}
           whileInView={{opacity:1,y:0}}
          ...
          <a href={"https://twitter.com/AyushKatoch17"} target="_blank">
            <motion.div initial={{opacity:0, y:100}}
           whileInView={{opacity:1,y:0}}
